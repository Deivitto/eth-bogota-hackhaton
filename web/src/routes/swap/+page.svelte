...
<script>
    ...
    $: dcaEnabled = document.querySelector("#chainlink_input")
        ? document.querySelector("#chainlink_input").value
        : ""
    ...
    $: amountOutput = document.querySelector("#amount2")
        ? document.querySelector("#amount2").value
        : ""
    // $: ping = 23123927
    // $: chain = "Arbitrum"
    // $: address = "0x000test"
    ...
    async function swap() {
        console.log(document.querySelector("#amount1"))
        console.log("swap worked", amountInput, amountOutput, dcaEnabled)
        dcaEnabled = document.querySelector("#chainlink_input").value
    ...
    async function submit(_buyAmount, _sellAmount) {
        ...
        sellAmount = _sellAmount != null ? _sellAmount : 1325.46
        buyAmount = _buyAmount != null ? _buyAmount : 1
        try {
            console.log("aqui")
            ...
            <div class="sc-1dv6j2d-1 cppDvG">
                ...
                <div class="sc-11ce2lf-0 bDmHPU">
                    <main id="swap-page" class="sc-11ce2lf-1 bAkuEV">
                        ...
                        <div class="sc-1kykgp9-2 jgeUFu">
                            ...
                            <div>
                                <button
                                    ...
                                    ><div on:click={swap} class="css-10ob8xa">Continue</div></button
                                >
                            </div>
                        </div>
                        ...
                        <div class="form-control  mt-2 ml-1 flex flex-row items-center" style="">
                            <label
                            ...
                            <span class="label-text ml-1 text-white"
                                >Enable automatic DCA of this swap</span
                            >
                        </div>
