...
<p class="subtitle">
    Simple example to using the <a href="https://web3modal.com/">Web3Modal</a> library to connect the
    default store.
</p>
...
<div class="field">
    <div class="control">
        <input
            class="input p-4"
            type="text"
            placeholder="InfuraId (to use walletconnect)"
            bind:value={infuraId}
        />
    </div>
</div>
...
{#if $connected}
    ...
    <p>
        Selected account balance = <Balance address={checkAccount} />
